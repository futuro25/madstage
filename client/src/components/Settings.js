...
export default function Settings() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const userUpdated = await mutate(
        API_URL,
        utils.patchRequest(`${API_URL}/${sessionStorage.userId}`, data),
        { optimisticData: true }
      );
                          ...
                          <td>
                            <div className="p-4 gap-4 flex flex-col items-start">
                              ...
                              <div
                                ...
                                className="absolute cursor-pointer px-2 w-[100px] h-[100px] rounded-full hover:text-black text-center pt-10 hover:bg-white/50 group"
                              >
                                <p className="group-hover:visible invisible cursor-pointer">
                                  Change
                                </p>
                              </div>
                              <AvatarThumb
                                ...
                                initials={utils.getNameInitials(
                        ...
                        <tr>
                          <td>
                            <div className="p-4 gap-2 flex items-center">
                              <label className="text-slate-500 w-36 font-bold">
                                MercadoPago Alias:
                              </label>
                              {editingMode ? (
                                <input
                                  ...
                                  type="text"
                                  defaultValue={user?.mercadopago_alias || ""}
                                  {...register("mercadopago_alias", {
                                    required: false,
                                  })}
                                  className="w-48 rounded border border-slate-200  p-2 text-slate-500 "
                                />
                              ) : (
                                <label className="text-slate-500 w-20">
                                  {user?.mercadopago_alias}
                                </label>
                              )}
                            ...
                            <div className="p-4 gap-2 flex items-center">
                              ...
                              {editingMode ? (
                                <textarea
                                  ...
                                  className="w-48 h-20 rounded border border-slate-200  p-2 text-slate-500 "
                                />
                              ) : (
                                <p className="text-slate-500 ml-[90px] h-24 text-ellipsis overflow-scroll">
                                  {user?.description}
                                </p>
                              )}
                            ...
                            <div className="p-4 gap-2 flex items-center">
                              ...
                              {editingMode ? (
                                <input
                                  ...
                                  {...register("ranking", { required: false })}
                                  className="w-48 rounded border border-slate-200  p-2 text-slate-500 "
                                />
                              ) : (
                                <label className="text-slate-500 w-20">
